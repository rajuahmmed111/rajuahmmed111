<div align="center">
<img src="assets/raju.png" alt="Md MD RAJU AHMMED - Software Engineer" width="100%" /> 
</div>
...
With over 1 years of production experience, I don't just write code—I engineer scalable solutions. My focus is on:
...
- 📱 [**Counta App**](https://play.google.com/store/apps/details?id=com.rita.counta_app) - Mobile app backend development
  ...
  **Tech Stack:** Node.js, Express.js, MongoDB, Prisma, JWT, Payment Gateway integrations , AWS Deployment
...
**Sparktech Agency IT LTD**, Mohakhali, Dhaka (August 2024 – Present)  
**Designation:** Full Stack Web Developer

**Job Responsibilities:**

- **Frontend:** HTML5, CSS3, Tailwind CSS, Material UI, JavaScript, React.js, Redux, Next.js, ShadCN, TypeScript
- **Backend:** Express.js, Node.js, TypeScript, MongoDB, PostgreSQL, Mongoose, Prisma, WebSocket, Multer, Node-Cron
- **Authentication:** JWT, OAuth
- **Payment Gateway:** SSLCommerz, Stripe, PayPal, Paystack, Flutterwave, Payoneer
- **Deployment:** AWS, Cloudflare, Vercel, Render, Netlify
